...
public abstract class Connection {
	...
	public Connection(DTNHost fromNode, NetworkInterface fromInterface, 
		...
		/**加入彼此相遇清單，並且傳遇過的人興趣值*/
		//fromNode.meetList.add(new HostMeet(toNode.toString(),toNode.getLocation(),SimClock.getTime(),toNode.get_P_interest()));
		//toNode.meetList.add(new HostMeet(fromNode.toString(),fromNode.getLocation(),SimClock.getTime(),fromNode.get_P_interest()));
		fromNode.meetList.add(new HostMeet(toNode.toString(),toNode.getLocation(),SimClock.getTime()));
		toNode.meetList.add(new HostMeet(toNode.toString(),toNode.getLocation(),SimClock.getTime()));
		
		//System.out.println("Connection___"+toNode.toString()+"\n");
		//System.out.println("Connection___"+toNode.getLocation()+"\n");
		//System.out.println("Connection___"+SimClock.getTime()+"\n");
		//System.out.println("Connection___"+toNode.pinterest+"\n");
